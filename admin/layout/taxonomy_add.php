...
<div class="row" >
	...
	<div class="col-md-3">
		...
		<form action="?run=taxonomy_ajax.php&key=<?php echo hm_get('key'); ?>&action=add" method="post" class="ajaxForm ajaxFormTaxonomyAdd">
	...
	<div class="col-md-9">
		<p class="page_action">
			...
			<button class="btn btn-default btn-xs taxonomy_status" data-status="public"><?php echo _('Đã đăng'); ?></button>
			<button class="btn btn-default btn-xs taxonomy_status" data-status="draft"><?php echo _('Thùng rác'); ?></button>
		</p>
		...
		<form action="?run=taxonomy_ajax.php&key=<?php echo hm_get('key'); ?>&action=multi" method="post" class="ajaxForm ajaxFormTaxonomyAction">
			<div class="table_action">
				<div class="table_action_left">
					...
					<button class="btn btn-default btn-xs multi_action" data-id="1"><?php echo _('Thực diện'); ?></button>
				</div>
